...
void init()
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), (GLvoid*)0);	//Specify the layout and format of vertex data stored in VBO
...
void display()
{
    ...
    glDrawArrays(GL_TRIANGLES, 0, 3);													//Draw the array of data
